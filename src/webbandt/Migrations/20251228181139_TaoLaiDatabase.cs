    ...
    public partial class TaoLaiDatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Hoadontamthois", x => x.HoTen);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_HangSanXuats_MaHang",
                        column: x => x.MaHang,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HoadontamthoiHoTen = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Sanphamtronggiohangs", x => x.ProductId);
                    table.ForeignKey(
                        name: "FK_Sanphamtronggiohangs_Hoadontamthois_HoadontamthoiHoTen",
                        column: x => x.HoadontamthoiHoTen,
                        principalTable: "Hoadontamthois",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChiTietDonHang_Products_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DanhGias_DanhGias_ParentId",
                        column: x => x.ParentId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NoiDung = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    QuanTriVien = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TraLoiBinhLuans_DanhGias_DanhGiaId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_MaHang",
                table: "Products",
                column: "MaHang");

            migrationBuilder.CreateIndex(
                name: "IX_Sanphamtronggiohangs_HoadontamthoiHoTen",
                table: "Sanphamtronggiohangs",
                column: "HoadontamthoiHoTen");

            migrationBuilder.CreateIndex(
                name: "IX_TraLoiBinhLuans_DanhGiaId",
