...
namespace webbandt.Areas.Identity.Pages.Account.Manage
{
    public class ChangePasswordModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            /// </summary>
            [Required]
            [StringLength(100, ErrorMessage = "Phải chiều dài tối thiểu  và ít nhất {1} ký tự.", MinimumLength = 6)]
            [DataType(DataType.Password)]
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            if (!hasPassword)
            {
                return RedirectToPage("./Đặt mật khẩu");
            }
